...
import com.example.common.repository.CollectionRepository;
...
public class CollectionServiceImpl implements CollectionService {
    ...
    public List<CollectionDto> findCollectionByName(String text){
        List<Collection> collections = collectionRepository.findCollectionByText(text);
